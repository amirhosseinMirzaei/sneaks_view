...
class _State extends State<ImageListView> {
 ...
 @override
  ...
  _autoScroll(){
   ...
   scheduleMicrotask((){
     _scrollController.animateTo(_currentScrollPosition==_endScrollPosition?0:_endScrollPosition, duration:  Duration(seconds: widget.duration), curve: Curves.linear);
   });
  }
  @override
